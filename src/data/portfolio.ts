...
export const portfolio: {
    ...
    projects: [
        ...
        {
            title: "Budget Craft",
            description: "A retro pixel-art US national budget simulator based on CBO baseline forecasts. Players adjust spending outlays and tax revenues to balance the budget and stabilize the visual 'national debt tower'.",
            image: "/photos/budget_craft.png",
            tags: ["React", "Vite", "Vanilla CSS", "SVG Design", "Data Modeling"],
            date: "May 2026",
            featured: true,
            repo: "https://github.com/ZenoCoding/budget-craft",
        },
        {
        ...
        {
            title: "Minute",
            description: "A native macOS menu-bar utility and local-first task planner designed for low-friction planning. Features natural language task capture, capacity-aware calendar timelines, and one-click deferral/pull-forward suggestions.",
            image: "/photos/minute_planner.png",
            tags: ["SwiftUI", "SwiftData", "EventKit", "macOS Development"],
            date: "February 2026",
            featured: true,
            repo: "https://github.com/ZenoCoding/Minute",
        },
        {
